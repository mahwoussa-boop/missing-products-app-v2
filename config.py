...
═══════════════════════════════════════════════════════
v13.2 — متوافق مع vision-2030-v26 (تمت إضافة إعدادات الصفحات والفلاتر الصارمة)
"""
...
# ═══════════ إعدادات الواجهة والفلترة الصارمة (تحديثات جديدة) ═══════════
ITEMS_PER_PAGE = 25           # عدد المنتجات المعروضة في كل صفحة (نظام الصفحات)
MIN_PRICE_THRESHOLD = 15.0    # الحد الأدنى للسعر (لتجاهل المنتجات الرخيصة جداً)
MIN_VOLUME_ML = 10.0          # الحد الأدنى للحجم بالملي (لتجاهل العينات الصغيرة)
...
# ═══════════ حدود المطابقة ═══════════
CONFIRMED_THRESHOLD = 80   # تطابق مؤكد (أحمر - متوفر مكرر)
SIMILAR_THRESHOLD = 45     # مشابه يحتاج مراجعة (أصفر)
...
REJECT_KEYWORDS = [
    ...
    "split", "miniature", "0.5ml", "1ml", "2ml", "3ml", "5ml"
]

TESTER_KEYWORDS = ["tester", "تستر", "تيستر", "بدون كرتون", "بدون غطاء", "(تستر)"]
SET_KEYWORDS = ["set", "gift set", "طقم", "مجموعة", "coffret", "هدايا"]
